...
import Business.Obj.MessageParser;
...
public class CHumanObject {
    ...
    public void handlerMsg(byte[] bytes) throws InvalidProtocolBufferException {
        ...
        int msgId = MessageParser.bytesToBigEndian32(bytes, 0);
        GeneratedMessage message = (GeneratedMessage) MessageParser.parser(msgId, bytes);
        if(message == null) {
            return;
        }
